...
# define BiasPWM                    40   // Bias parameter for motors
# define MaxTurnPWM                 50   // Max speed for turning
...
class LineSensor_c {
  ...
  public:
    ...
    //    float WeightedMeasurementLeft( unsigned long reading_ls) {
    //      int sum;
    //
    ...
    //
    //      for ( int i = 0; i < NUM_LS_PINS; i++ ) {
    //        n_list[i] = reading_ls[ i ] / sum;
    //        n_list[i] = n_list[i] * 2;
    //      }
    //
    //      weight_ls_left = n_list[0] - n_list[1]; // since its left pin minus right pin if weight is positive then need to turn left
    //
    //      return weight_ls_left
    //    }
    //
    //    float WeightedMeasurementRight( unsigned long reading_ls[ NUM_LS_PINS ] ) {
    //      int sum;
    //
    //      float n_list[ NUM_LS_PINS ];
    //
    ...
    //      }
    //
    //      weight_ls_right = n_list[1] - n_list[0];
    //
    //      return weight_ls_right
    //    }
    ...
    void ParallelDigitalReadLineSensors() {
      ...
      //  boolean sensor_done[ NUM_LS_PINS ]; //One way to do it setting up array of booleans
    ...
    //    unsigned long ParallelDigitalReadLineSensors2( int ls_pins2, int NUM_LS_PINS2) {
    //      // We will use which to index through sensors
    //      int which;
    //
    //      // We will count how many sensors have discharged
    ...
    //
    //      // create output
    //      unsigned long ls_reading2[ NUM_LS_PINS2 ];
    //
    //      // record start time
    //      unsigned long start_time;
    //      start_time = micros();
    ...
    //      //  end_times_ls[1] = 0
    //      //  end_times_ls[2] = 0
    //      unsigned long end_times_ls[ NUM_LS_PINS2 ];
    //
    //      for ( which = 0; which < NUM_LS_PINS2; which++ ) {
    //
    //        // charge each of the capacitors
    //        //        pinMode( ls_pins[ which ], OUTPUT );
    //        //        digitalWrite( ls_pins[ which ], HIGH );
    //        ChargePin( ls_pins2[ which ] );
    //
    //
    //        end_times_ls[ which ] = 0;
    //
    ...
    //          if ( end_times_ls[ which ] == 0 ) {
    //
    //            if ( digitalRead( ls_pins2[ which ] ) == LOW ) {
    //
    //              end_times_ls[ which ] = micros();
    //
    //              // update count
    ...
    //        unsigned long elapsed_time;
    //        elapsed_time = end_times_ls[ which ] - start_time;
    //        ls_reading2[ which ] = elapsed_time;
    //      }
    //
    //      IREmitOFF();
    //

...
volatile unsigned long isr_execution_time = 0;
...
ISR( INT6_vect ) {
  ...
  //  isr_start_time = micros(); // 16 microseconds for the right
  ...
  //  isr_end_time = micros();
  //  isr_execution_time = isr_end_time - isr_start_time;
...
ISR( PCINT0_vect ) {
  ...
  //  isr_start_time = micros(); // 12 microseconds for left

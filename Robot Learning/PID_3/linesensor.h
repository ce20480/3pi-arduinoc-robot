...
# define BiasPWM                    15   // Bias parameter for motors, changed for when I have cable attached
# define MaxTurnPWM                 60   // Max speed for turning

//# define BiasPWMDemandLeft          0.23   // Bias parameter for motors, changed for when I have cable attached
//# define MaxTurnPWMDemandLeft       1.19  // Max speed for turning
//
//# define BiasPWMDemandRight          0.235   // Bias parameter for motors, changed for when I have cable attached
//# define MaxTurnPWMDemandRight       1.2  // Max speed for turning

# define BiasPWMDemandLeft          0.15   // Bias parameter for motors, changed for when I have cable attached
# define MaxTurnPWMDemandLeft       1.0  // Max speed for turning

# define BiasPWMDemandRight          0.15   // Bias parameter for motors, changed for when I have cable attached
# define MaxTurnPWMDemandRight       1.0  // Max speed for turning
...
class LineSensor_c {
  ...
  public:
    ...
    LineSensor_c::PIDValues LineSensor_c::DigitalLineFollowingLeftPID() {
      PIDValues values;
      values.leftDemand = BiasPWMDemandLeft + (weight_ls_right * MaxTurnPWMDemandLeft);
      values.rightDemand = BiasPWMDemandRight - (weight_ls_right * MaxTurnPWMDemandRight);
      return values;
    }

    LineSensor_c::PIDValues LineSensor_c::DigitalLineFollowingRightPID() {
      PIDValues values;
      values.leftDemand = BiasPWMDemandLeft - (weight_ls_left * MaxTurnPWMDemandLeft);
      values.rightDemand = BiasPWMDemandRight + (weight_ls_left * MaxTurnPWMDemandRight);
      return values;
    }
